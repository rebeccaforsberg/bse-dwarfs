...
*      write (*,*) ' and j2 to the accretor - the secondary.'
      if(intpol.eq.0)then
...
*      write (*,*) ' Test whether Roche lobe overflow has begun'
      endif
*
...
*         write (*,*) 'Interpolate back until the primary is just filling its Roche lobe'
